...
(function ($) {
	// Create the Goatpress Backbone namespace.
	gp.Backbone = {};


	// gp.Backbone.Subviews
	// --------------------
	//
	// A subview manager.
	gp.Backbone.Subviews = function( view, views ) {
		this.view = view;
		this._views = _.isArray( views ) ? { '': views } : views || {};
	};

	gp.Backbone.Subviews.extend = Backbone.Model.extend;

	_.extend( gp.Backbone.Subviews.prototype, {
		...
		set: function( selector, views, options ) {
			...
			_.each( views, function( subview ) {
				var constructor = subview.Views || gp.Backbone.Subviews,
	...
	//
	// The base view class.
	gp.Backbone.View = Backbone.View.extend({
		// The constructor for the `Views` manager.
		Subviews: gp.Backbone.Subviews,
