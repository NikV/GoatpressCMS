...
( function( window, settings ) {
	function gpEmoji() {
		 ...
		 */
		if ( settings ) {
			supportsEmoji = window._gpemojiSettings.supports.simple;
			supportsFlagEmoji = window._gpemojiSettings.supports.flag;
	...
	window.gp = window.gp || {};
	window.gp.emoji = new gpEmoji();

} )( window, window._gpemojiSettings );
