...
( function() {
	...
	tinyMCE.addI18n( lang + ".Goatpress", {
		gp_adv_desc: "Show/Hide Kitchen Sink (Alt + Shift + Z)",
		gp_more_desc: "Insert More Tag (Alt + Shift + T)",
		gp_page_desc: "Insert Page break (Alt + Shift + P)",
		gp_help_desc: "Help (Alt + Shift + H)",
		gp_more_alt: "More...",
		gp_page_alt: "Next page...",
		add_media: "Add Media",
		...
		gp_fullscreen_desc: "Distraction-free writing mode (Alt + Shift + W)"
	});

	tinyMCE.addI18n( lang + ".gpeditimage", {
		edit_img: "Edit Image",
