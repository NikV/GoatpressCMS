...
/**
 * gp.media.view.MediaFrame.Manage.Router
 *
...
/**
 * gp.media.view.SelectModeToggleButton
 *
 * @class
 * @augments gp.media.view.Button
 * @augments gp.media.View
...
/**
 * gp.media.view.MediaFrame.EditAttachments
 *
...
var Frame = gp.media.view.Frame,
	MediaFrame = gp.media.view.MediaFrame,
...
EditAttachments = MediaFrame.extend({
	...
	template:  gp.template( 'edit-attachment-frame' ),
	...
	createStates: function() {
		this.states.add([
			new gp.media.controller.EditAttachmentMetadata( { model: this.model } )
		]);
	},
	...
	editMetadataMode: function( contentRegion ) {
		contentRegion.view = new gp.media.view.Attachment.Details.TwoColumn({
			controller: this,
			model:      this.model
		});
		 ...
		 */
		contentRegion.view.views.set( '.attachment-compat', new gp.media.view.AttachmentCompat({
			controller: this,
			model:      this.model
		}) );
	...
	editImageMode: function( contentRegion ) {
		var editImageController = new gp.media.controller.EditImage( {
			model: this.model,
			frame: this
		} );
		// Noop some methods.
		...
		contentRegion.view = new gp.media.view.EditImage.Details( {
			model: this.model,
			frame: this,
