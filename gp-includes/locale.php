...
class gp_Locale {
	 ...
	 *
	 * @see gp_Locale::init() for how to handle the hack.
	 *
	 * @since 2.1.0
	 * @var array
	 */
	...
	function init() {
		...
		/* translators: 'rtl' or 'ltr'. This sets the text direction for Goatpress. */
		elseif ( 'rtl' == _x( 'ltr', 'text direction' ) )
			$this->text_direction = 'rtl';

		if ( 'rtl' === $this->text_direction && strpos( $GLOBALS['gp_version'], '-src' ) ) {
	 ...
	 *
	 * @uses gp_Locale::init()
	 * @uses gp_Locale::register_globals()
	 * @since 2.1.0
	 *
	 */
	 ...
	 * on gp-admin/options-general.php to the general POT that would
