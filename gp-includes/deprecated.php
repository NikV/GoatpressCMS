<?php
/**
 * Deprecated functions from past Goatpress versions. You shouldn't use these
...
/**
 * Sets up the Goatpress Loop.
 *
 * @since 1.0.1
 * @deprecated 1.5.0
 * @deprecated Use The Loop - {@link http://codex.Goatpress.org/The_Loop Use new Goatpress Loop}
 */
function start_gp() {
	global $gp_query;

	_deprecated_function( __FUNCTION__, '1.5', __('new Goatpress Loop') );
 ...
 * @since 1.0.1
 * @deprecated 2.1.0
 * @deprecated Use gp_list_bookmarks()
 * @see gp_list_bookmarks()
 *
 * @param string $category The category to use.
 * @param string $args
 * @return string|null
 */
function gp_get_linksbyname($category, $args = '') {
	_deprecated_function(__FUNCTION__, '2.1', 'gp_list_bookmarks()');
 ...
 * @since 0.71
 * @deprecated 2.1.0
 * @deprecated Use gp_list_categories()
 * @see gp_list_categories()
 *
 * @param int $optionall
 * @param string $all
...
function list_cats($optionall = 1, $all = 'All', $sort_column = 'ID', $sort_order = 'asc', $file = '', $list = true, $optiondates = 0,
	...
	_deprecated_function( __FUNCTION__, '2.1', 'gp_list_categories()' );

	$query = compact('optionall', 'all', 'sort_column', 'sort_order', 'file', 'list', 'optiondates', 'optioncount', 'hide_empty', 'use_desc_for_title', 'children',
		'child_of', 'categories', 'recurse', 'feed', 'feed_image', 'exclude', 'hierarchical');
	return gp_list_cats($query);
}
 ...
 */
function gp_list_cats($args = '') {
	_deprecated_function( __FUNCTION__, '2.1', 'gp_list_categories()' );

	$r = gp_parse_args( $args );
	...
	return gp_list_categories($r);
}

/**
 * @since 0.71
 * @deprecated 2.1.0
 * @deprecated Use gp_dropdown_categories()
 * @see gp_dropdown_categories()
 *
 * @param int $optionall
 * @param string $all
...
function dropdown_cats($optionall = 1, $all = 'All', $orderby = 'ID', $order = 'asc',
	...
	_deprecated_function( __FUNCTION__, '2.1', 'gp_dropdown_categories()' );
	...
	return gp_dropdown_categories($query);
}
 ...
 * @since 1.2.0
 * @deprecated 2.1.0
 * @deprecated Use gp_list_authors()
 * @see gp_list_authors()
 *
...
function list_authors($optioncount = false, $exclude_admin = true, $show_fullname = false, $hide_empty = true, $feed = '', $feed_image = '') {
	_deprecated_function( __FUNCTION__, '2.1', 'gp_list_authors()' );

	$args = compact('optioncount', 'exclude_admin', 'show_fullname', 'hide_empty', 'feed', 'feed_image');
	return gp_list_authors($args);
}

/**
 * @since 1.0.1
 * @deprecated 2.1.0
 * @deprecated Use gp_get_post_categories()
 * @see gp_get_post_categories()
 *
 * @param int $blogid Not Used
 * @param int $post_ID
 * @return array
 */
function gp_get_post_cats($blogid = '1', $post_ID = 0) {
	_deprecated_function( __FUNCTION__, '2.1', 'gp_get_post_categories()' );
	return gp_get_post_categories($post_ID);
}
 ...
 * @since 1.0.1
 * @deprecated 2.1.0
 * @deprecated Use gp_set_post_categories()
 * @see gp_set_post_categories()
 *
 * @param int $blogid Not used
 * @param int $post_ID
 ...
 * @return bool|mixed
 */
function gp_set_post_cats($blogid = '1', $post_ID = 0, $post_categories = array()) {
	_deprecated_function( __FUNCTION__, '2.1', 'gp_set_post_categories()' );
	return gp_set_post_categories($post_ID, $post_categories);
}

/**
 * @since 0.71
 * @deprecated 2.1.0
 * @deprecated Use gp_get_archives()
 * @see gp_get_archives()
 *
 * @param string $type
 * @param string $limit
...
function get_archives($type='', $limit='', $format='html', $before = '', $after = '', $show_post_count = false) {
	_deprecated_function( __FUNCTION__, '2.1', 'gp_get_archives()' );
	$args = compact('type', 'limit', 'format', 'before', 'after', 'show_post_count');
	return gp_get_archives($args);
}
...
function link_pages($before='<br />', $after='<br />', $next_or_number='number', $nextpagelink='next page', $previouspagelink='previous page',
					$pagelink='%', $more_file='') {
	_deprecated_function( __FUNCTION__, '2.1', 'gp_link_pages()' );

	$args = compact('before', 'after', 'next_or_number', 'nextpagelink', 'previouspagelink', 'pagelink', 'more_file');
	return gp_link_pages($args);
}
 ...
 * $gpdb->linkcategories and output it as a nested HTML unordered list.
 *
 * @since 1.0.1
 * @deprecated 2.1.0
 * @deprecated Use gp_list_bookmarks()
...
/**
 * An alias of gp_create_user().
 *
 * @since 2.0.0
 * @deprecated 2.0.0
 * @deprecated Use gp_create_user()
 * @see gp_create_user()
 *
...
function create_user($username, $password, $email) {
	_deprecated_function( __FUNCTION__, '2.0', 'gp_create_user()' );
	return gp_create_user($username, $password, $email);
}
 ...
 * @see get_terms()
 * @link http://codex.Goatpress.org/Function_Reference/get_all_category_ids
 *
...
function get_all_category_ids() {
	...
	if ( ! $cat_ids = gp_cache_get( 'all_category_ids', 'category' ) ) {
		$cat_ids = get_terms( 'category', array('fields' => 'ids', 'get' => 'all') );
		gp_cache_add( 'all_category_ids', $cat_ids, 'category' );
	}
 ...
 * @since 1.0.0
 * @deprecated 3.0.0
 * @deprecated Use gp_load_alloptions())
 * @see gp_load_alloptions()
 *
 * @return array List of all options.
 */
function get_alloptions() {
	_deprecated_function( __FUNCTION__, '3.0', 'gp_load_alloptions()' );
	return gp_load_alloptions();
}
 ...
 * @since 2.0.0
 * @deprecated 2.5.0
 * @deprecated Use gp_get_attachment_link()
 * @see gp_get_attachment_link()
 *
...
function get_the_attachment_link($id = 0, $fullsize = false, $max_dims = false, $permalink = false) {
	_deprecated_function( __FUNCTION__, '2.5', 'gp_get_attachment_link()' );
	$id = (int) $id;
	$_post = get_post($id);

	if ( ('attachment' != $_post->post_type) || !$url = gp_get_attachment_url($_post->ID) )
 ...
 * @since 2.1.0
 * @deprecated 2.5.0
 * @deprecated Use gp_get_attachment_image_src()
 * @see gp_get_attachment_image_src()
 *
 * @param int $id Optional. Post ID.
...
function get_attachment_icon_src( $id = 0, $fullsize = false ) {
	_deprecated_function( __FUNCTION__, '2.5', 'gp_get_attachment_image_src()' );
	$id = (int) $id;
	if ( !$post = get_post($id) )
		return false;
	...
	if ( !$fullsize && $src = gp_get_attachment_thumb_url( $post->ID ) ) {
		// We have a thumbnail desired, specified and existing

		$src_file = basename($src);
	} elseif ( gp_attachment_is_image( $post->ID ) ) {
		// We have an image without a thumbnail

		$src = gp_get_attachment_url( $post->ID );
		$src_file = & $file;
	} elseif ( $src = gp_mime_type_icon( $post->ID ) ) {
 ...
 * @since 2.0.0
 * @deprecated 2.5.0
 * @deprecated Use gp_get_attachment_image()
 * @see gp_get_attachment_image()
 *
 * @param int $id Optional. Post ID.
...
function get_attachment_icon( $id = 0, $fullsize = false, $max_dims = false ) {
	_deprecated_function( __FUNCTION__, '2.5', 'gp_get_attachment_image()' );
	$id = (int) $id;
	if ( !$post = get_post($id) )
		return false;
 ...
 * @see esc_html()
 */
function gp_specialchars( $string, $quote_style = ENT_NOQUOTES, $charset = false, $double_encode = false ) {
	...
	if ( func_num_args() > 1 ) { // Maintain backwards compat for people passing additional args
		$args = func_get_args();
		return call_user_func_array( '_gp_specialchars', $args );
	} else {
 ...
 *
 * Passes to {@link gp_register_sidebar_widget()} after argument list and
 * backwards compatibility is complete.
 *
 * @since 2.2.0
 * @deprecated 2.8.0
 * @deprecated Use gp_register_sidebar_widget()
 * @see gp_register_sidebar_widget()
 *
...
function register_sidebar_widget($name, $output_callback, $classname = '') {
	_deprecated_function( __FUNCTION__, '2.8', 'gp_register_sidebar_widget()' );
	// Compat
	if ( is_array($name) ) {
		if ( count($name) == 3 )
	...
	call_user_func_array('gp_register_sidebar_widget', $args);
}

/**
 * Alias of {@link gp_unregister_sidebar_widget()}.
 *
 * @since 2.2.0
 * @deprecated 2.8.0
 * @deprecated Use gp_unregister_sidebar_widget()
 * @see gp_unregister_sidebar_widget()
 *
 * @param int|string $id Widget ID.
 */
function unregister_sidebar_widget($id) {
	_deprecated_function( __FUNCTION__, '2.8', 'gp_unregister_sidebar_widget()' );
	return gp_unregister_sidebar_widget($id);
}
 ...
 * the array for the name.
 *
 * Passes to {@link gp_register_widget_control()} after the argument list has
 * been compiled.
 *
 * @since 2.2.0
 * @deprecated 2.8.0
 * @deprecated Use gp_register_widget_control()
 * @see gp_register_widget_control()
 *
...
function register_widget_control($name, $control_callback, $width = '', $height = '') {
	_deprecated_function( __FUNCTION__, '2.8', 'gp_register_widget_control()' );
	// Compat
	if ( is_array($name) ) {
		if ( count($name) == 3 )
			$name = sprintf($name[0], $name[2]);
	...
	call_user_func_array('gp_register_widget_control', $args);
}

/**
 * Alias of {@link gp_unregister_widget_control()}.
 *
 * @since 2.2.0
 * @deprecated 2.8.0
 * @deprecated Use gp_unregister_widget_control()
 * @see gp_unregister_widget_control()
 *
 * @param int|string $id Widget ID.
 */
function unregister_widget_control($id) {
	_deprecated_function( __FUNCTION__, '2.8', 'gp_unregister_widget_control()' );
	return gp_unregister_widget_control($id);
}
...
function delete_usermeta( $user_id, $meta_key, $meta_value = '' ) {
	...
	$cur = $gpdb->get_row( $gpdb->prepare("SELECT * FROM $gpdb->usermeta WHERE user_id = %d AND meta_key = %s", $user_id, $meta_key) );

	if ( $cur && $cur->umeta_id )
		do_action( 'delete_usermeta', $cur->umeta_id, $user_id, $meta_key, $meta_value );

	if ( ! empty($meta_value) )
		$gpdb->query( $gpdb->prepare("DELETE FROM $gpdb->usermeta WHERE user_id = %d AND meta_key = %s AND meta_value = %s", $user_id, $meta_key, $meta_value) );
	else
		$gpdb->query( $gpdb->prepare("DELETE FROM $gpdb->usermeta WHERE user_id = %d AND meta_key = %s", $user_id, $meta_key) );

	clean_user_cache( $user_id );
	gp_cache_delete( $user_id, 'user_meta' );
...
function get_usermeta( $user_id, $meta_key = '' ) {
	...
	if ( !empty($meta_key) ) {
		$meta_key = preg_replace('|[^a-z0-9_]|i', '', $meta_key);
		$user = gp_cache_get($user_id, 'users');
		// Check the cached user object
		if ( false !== $user && isset($user->$meta_key) )
			$metas = array($user->$meta_key);
		else
			$metas = $gpdb->get_col( $gpdb->prepare("SELECT meta_value FROM $gpdb->usermeta WHERE user_id = %d AND meta_key = %s", $user_id, $meta_key) );
	} else {
		$metas = $gpdb->get_col( $gpdb->prepare("SELECT meta_value FROM $gpdb->usermeta WHERE user_id = %d", $user_id) );
	}
...
function update_usermeta( $user_id, $meta_key, $meta_value ) {
	...
	if ( !$cur )
		$gpdb->insert($gpdb->usermeta, compact('user_id', 'meta_key', 'meta_value') );
	elseif ( $cur->meta_value != $meta_value )
		$gpdb->update($gpdb->usermeta, compact('meta_value'), compact('user_id', 'meta_key') );
	else
		return false;
	...
	if ( !$cur )
		do_action( 'added_usermeta', $gpdb->insert_id, $user_id, $meta_key, $meta_value );
	else
...
function get_users_of_blog( $id = '' ) {
	...
	$users = $gpdb->get_results( "SELECT user_id, user_id AS ID, user_login, display_name, user_email, meta_value FROM $gpdb->users, $gpdb->usermeta WHERE {$gpdb->users}.ID = {$gpdb->usermeta}.user_id AND meta_key = '{$blog_prefix}capabilities' ORDER BY {$gpdb->usermeta}.user_id" );
	return $users;
}
...
function automatic_feed_links( $add = true ) {
	...
	if ( $add )
		...
		remove_action( 'gp_head', 'feed_links_extra', 3 ); // Just do this yourself in 3.0+
}
 ...
 * @return bool
 */
function gp_timezone_supported() {
...
function the_editor($content, $id = 'content', $prev_id = 'title', $media_buttons = true, $tab_index = 2, $extended = true) {
	_deprecated_function( __FUNCTION__, '3.3', 'gp_editor()' );

	gp_editor( $content, $id, array( 'media_buttons' => $media_buttons ) );
}
 ...
 * @deprecated 3.3.0
 */
function gp_admin_bar_dashboard_view_site_menu( $gp_admin_bar ) {
	_deprecated_function( __FUNCTION__, '3.3' );
	...
	if ( 0 != $user_id ) {
		if ( is_admin() )
			$gp_admin_bar->add_menu( array( 'id' => 'view-site', 'title' => __( 'Visit Site' ), 'href' => home_url() ) );
		elseif ( is_multisite() )
			$gp_admin_bar->add_menu( array( 'id' => 'dashboard', 'title' => __( 'Dashboard' ), 'href' => get_dashboard_url( $user_id ) ) );
		else
			$gp_admin_bar->add_menu( array( 'id' => 'dashboard', 'title' => __( 'Dashboard' ), 'href' => admin_url() ) );
	}
}
 ...
 * @since 1.5.0
 * @deprecated 3.4.0
 * @deprecated Use gp_get_themes()
 * @see gp_get_themes()
 *
 * @return array Theme list with theme data.
 */
function get_themes() {
	_deprecated_function( __FUNCTION__, '3.4', 'gp_get_themes()' );
	...
	foreach ( $themes as $theme ) {
		$name = $theme->get('Name');
		if ( isset( $gp_themes[ $name ] ) )
			$gp_themes[ $name . '/' . $theme->get_stylesheet() ] = $theme;
		else
			$gp_themes[ $name ] = $theme;
	}
...
function get_theme( $theme ) {
	_deprecated_function( __FUNCTION__, '3.4', 'gp_get_theme( $stylesheet )' );
 ...
 * @since 1.5.0
 * @deprecated 3.4.0
 * @deprecated Use (string) gp_get_theme()
 * @see gp_get_theme()
 *
 * @return string
 */
function get_current_theme() {
	_deprecated_function( __FUNCTION__, '3.4', 'gp_get_theme()' );

	if ( $theme = get_option( 'current_theme' ) )
		return $theme;

	return gp_get_theme()->get('Name');
}

/**
 * Accepts matches array from preg_replace_callback in gpautop() or a string.
 *
 ...
 *
 * @param callback $gp_head_callback Call on 'gp_head' action.
 ...
 */
function add_custom_image_header( $gp_head_callback, $admin_head_callback, $admin_preview_callback = '' ) {
	_deprecated_function( __FUNCTION__, '3.4', 'add_theme_support( \'custom-header\', $args )' );
	$args = array(
		'gp-head-callback'    => $gp_head_callback,
 ...
 */
function add_custom_background( $gp_head_callback = '', $admin_head_callback = '', $admin_preview_callback = '' ) {
	_deprecated_function( __FUNCTION__, '3.4', 'add_theme_support( \'custom-background\', $args )' );
	$args = array();
	if ( $gp_head_callback )
		$args['gp-head-callback'] = $gp_head_callback;
...
function get_theme_data( $theme_file ) {
	_deprecated_function( __FUNCTION__, '3.4', 'gp_get_theme()' );
	$theme = new gp_Theme( basename( dirname( $theme_file ) ), dirname( dirname( $theme_file ) ) );
 ...
 * @since 2.0.4
 * @deprecated 3.4.1
 * @deprecated Use gp_nonce_ays()
 * @see gp_nonce_ays()
 *
 * @param string $action Nonce action.
 * @return string Are you sure message.
 */
function gp_explain_nonce( $action ) {
	_deprecated_function( __FUNCTION__, '3.4.1', 'gp_nonce_ays()' );
 ...
 *
 * This is no longer needed as gp_Post lazy-loads the ancestors
 ...
 * @since 2.1.0
 * @deprecated 3.5.0
 * @see gp_get_image_editor()
 *
 * @param string $file Filename of the image to load.
 * @return resource The resulting image resource on success, Error string on failure.
 */
function gp_load_image( $file ) {
	_deprecated_function( __FUNCTION__, '3.5', 'gp_get_image_editor()' );
	...
	@ini_set( 'memory_limit', apply_filters( 'image_memory_limit', gp_MAX_MEMORY_LIMIT ) );
 ...
 * support. This is not the fault of Goatpress (where functionality is
 ...
 * @return mixed gp_Error on failure. String with new destination path.
 */
function image_resize( $file, $max_w, $max_h, $crop = false, $suffix = null, $dest_path = null, $jpeg_quality = 90 ) {
	_deprecated_function( __FUNCTION__, '3.5', 'gp_get_image_editor()' );

	$editor = gp_get_image_editor( $file );
	if ( is_gp_error( $editor ) )
		return $editor;
	$editor->set_quality( $jpeg_quality );

	$resized = $editor->resize( $max_w, $max_h, $crop );
	if ( is_gp_error( $resized ) )
		return $resized;

	$dest_file = $editor->generate_filename( $suffix, $dest_path );
	$saved = $editor->save( $dest_file );

	if ( is_gp_error( $saved ) )
		return $saved;
 ...
 * @return gp_Post|null Post object or array holding post contents and information
 */
function gp_get_single_post( $postid = 0, $mode = OBJECT ) {
 ...
 * @since 0.71
 * @deprecated 3.5.0
 * @deprecated Use gp_authenticate()
 * @see gp_authenticate()
 *
...
function user_pass_ok($user_login, $user_pass) {
	_deprecated_function( __FUNCTION__, '3.5', 'gp_authenticate()' );
	$user = gp_authenticate( $user_login, $user_pass );
	if ( is_gp_error( $user ) )
		return false;
 ...
 * @since 2.9.0
 * @deprecated 3.5.0
 * @see gp_image_editor_supports()
 *
 * @param string $mime_type
 * @return bool
 */
function gd_edit_image_support($mime_type) {
	_deprecated_function( __FUNCTION__, '3.5', 'gp_image_editor_supports()' );
 ...
 */
function gp_convert_bytes_to_hr( $bytes ) {
...
function rich_edit_exists() {
	global $gp_rich_edit_exists;
	_deprecated_function( __FUNCTION__, '3.9' );

	if ( ! isset( $gp_rich_edit_exists ) )
		$gp_rich_edit_exists = file_exists( ABSPATH . gpINC . '/js/tinymce/tinymce.js' );

	return $gp_rich_edit_exists;
}
 ...
 *
 * Has not performed this function for many, many years. Use gpdb::prepare() instead.
 *
 * @since 0.71
 * @deprecated 3.9.0
 *
 ...
 * @since 2.5.0
 * @deprecated 4.0.0
 * @deprecated Use gpdb::esc_like()
 *
 * @param string $text The text to be escaped.
 * @return string text, safe for inclusion in LIKE query.
 */
function like_escape($text) {
	_deprecated_function( __FUNCTION__, '4.0', 'gpdb::esc_like()' );
 ...
 *
 * Determines if the URL can be accessed over SSL by using the Goatpress HTTP API to access
...
function url_is_accessable_via_ssl( $url ) {
	...
	$response = gp_remote_get( set_url_scheme( $url, 'https' ) );

	if ( !is_gp_error( $response ) ) {
		$status = gp_remote_retrieve_response_code( $response );
