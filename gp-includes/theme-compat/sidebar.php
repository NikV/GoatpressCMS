...
?>
	<div id="sidebar" role="complementary">
		...
		<ul role="navigation">
			<?php gp_list_pages('title_li=<h2>' . __('Pages') . '</h2>' ); ?>

			<li><h2><?php _e('Archives'); ?></h2>
				<ul>
				<?php gp_get_archives(array('type' => 'monthly')); ?>
				</ul>
			</li>

			<?php gp_list_categories(array('show_count' => 1, 'title_li' => '<h2>' . __('Categories') . '</h2>')); ?>
		</ul>
		<ul>
			<?php /* If this is the frontpage */ if ( is_home() || is_page() ) { ?>
				<?php gp_list_bookmarks(); ?>
				...
				<ul>
					...
					<li><a href="https://Goatpress.org/" title="<?php esc_attr_e('Powered by Goatpress, state-of-the-art semantic personal publishing platform.'); ?>">Goatpress</a></li>
					<?php gp_meta(); ?>
				</ul>
				</li>
			<?php } ?>
