<?php
/**
 * Goatpress Diff bastard child of old MediaWiki Diff Formatter.
 *
 ...
 */
class gp_Text_Diff_Renderer_Table extends Text_Diff_Renderer {
	 ...
	 * @since 2.6.0
	 */
	protected $inline_diff_renderer = 'gp_Text_Diff_Renderer_inline';
	...
	public function _deleted( $lines, $encode = true ) {
		...
		foreach ($lines as $line) {
			if ( $encode ) {
				...
				/** This filter is documented in gp-includes/gp-diff.php */
 ...
 */
class gp_Text_Diff_Renderer_inline extends Text_Diff_Renderer_inline {
