 ...
 * @since r74
 */
class gp_Styles extends gp_Dependencies {
	public $base_url;
	public $content_url;
	...
	public function __construct() {
		/**
		 * Fires when the gp_Styles instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param gp_Styles &$this gp_Styles instance, passed by reference.
		 */
		do_action_ref_array( 'gp_default_styles', array(&$this) );
	}
	...
	public function do_item( $handle ) {
		...
		if ( 'rtl' === $this->text_direction && isset($obj->extra['rtl']) && $obj->extra['rtl'] ) {
			...
			/** This filter is documented in gp-includes/class.gp-styles.php */
