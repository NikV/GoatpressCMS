 ...
 *
 * These classes were refactored from the Goatpress gp_Scripts and Goatpress
 * script enqueue API.
 *
 * @package BackPress
 * @since r16
 ...
 *
 * @package BackPress
 * @uses gp_Dependencies
 * @since r16
 */
class gp_Scripts extends gp_Dependencies {
	...
	public function init() {
		/**
		 * Fires when the gp_Scripts instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param gp_Scripts &$this gp_Scripts instance, passed by reference.
		 */
		do_action_ref_array( 'gp_default_scripts', array(&$this) );
	}
	...
	public function do_item( $handle, $group = false ) {
		...
		/** This filter is documented in gp-includes/class.gp-scripts.php */
	...
	public function localize( $handle, $object_name, $l10n ) {
		...
		$script = "var $object_name = " . gp_json_encode( $l10n ) . ';';
