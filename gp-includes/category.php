 ...
 * @link http://codex.Goatpress.org/Function_Reference/get_categories
 *
 ...
 * @return object|array|gp_Error|null Category data in type defined by $output parameter. gp_Error if $category is empty, null if it does not exist.
 */
 ...
 *
 * It is also possible that it will return a gp_Error object on failure. Check
...
function get_cat_name( $cat_id ) {
	...
	if ( ! $category || is_gp_error( $category ) )
		return '';
 ...
 * @param string $output Optional. Constant OBJECT, ARRAY_A, or ARRAY_N
 * @param string $filter Optional. Default is raw or no Goatpress defined filter will applied.
 * @return object|array|gp_Error|null Tag data in type defined by $output parameter. gp_Error if $tag is empty, null if it does not exist.
 */
