<?php
/**
 * Goatpress Customize Setting classes
 *
 * @package Goatpress
...
class gp_Customize_Setting {
	 ...
	 *
	 * @see gp_Customize_Setting::preview()
	 * @since 4.1.1
	 * @var mixed
	 */
	...
	public function preview() {
		...
		switch( $this->type ) {
			...
			default :
				...
				/**
				 * Fires when the {@see gp_Customize_Setting::preview()} method is called for settings
				 ...
				 * @since 3.4.0
				 *
				 * @param gp_Customize_Setting $this {@see gp_Customize_Setting} instance.
				 */
	 ...
	 *
	 * @since 3.4.0
	 * @uses gp_Customize_Setting::multidimensional_replace()
	 *
	...
	final public function save() {
		...
		/**
		 * Fires when the gp_Customize_Setting::save() method is called.
		 *
	...
	public function sanitize( $value ) {
		 ...
		 * @param gp_Customize_Setting $this  gp_Customize_Setting instance.
		 */
	...
	protected function update( $value ) {
		switch( $this->type ) {
			...
			default :
				...
				/**
				 * Fires when the {@see gp_Customize_Setting::update()} method is called for settings
				 * not handled as theme_mods or options.
				 *
 ...
 */
class gp_Customize_Filter_Setting extends gp_Customize_Setting {
 ...
 * @see gp_Customize_Setting
 */
final class gp_Customize_Header_Image_Setting extends gp_Customize_Setting {
 ...
 * @see gp_Customize_Setting
 */
final class gp_Customize_Background_Image_Setting extends gp_Customize_Setting {
