 ...
 *
 * @link http://codex.Goatpress.org/Widgets_API#Developing_Widgets
 *
 * @package Goatpress
 * @subpackage Twenty_Eleven
 * @since Twenty Eleven 1.0
 */
class Twenty_Eleven_Ephemera_Widget extends gp_Widget {
	...
	function Twenty_Eleven_Ephemera_Widget() {
		...
		$this->gp_Widget( 'widget_twentyeleven_ephemera', __( 'Twenty Eleven Ephemera', 'twentyeleven' ), $widget_ops );
	...
	function widget( $args, $instance ) {
		$cache = gp_cache_get( 'widget_twentyeleven_ephemera', 'widget' );
		...
		$ephemera = new gp_Query( $ephemera_args );
		...
		gp_cache_set( 'widget_twentyeleven_ephemera', $cache, 'widget' );
	}
	...
	function flush_widget_cache() {
		gp_cache_delete( 'widget_twentyeleven_ephemera', 'widget' );
	}

	/**
	 * Set up the widget form.
	 *
	 * Displays the form for this widget on the Widgets page of the gp Admin area.
	 *
	 * @since Twenty Eleven 1.0
	 **/
