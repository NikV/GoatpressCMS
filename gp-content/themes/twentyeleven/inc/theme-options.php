...
function twentyeleven_admin_enqueue_scripts( $hook_suffix ) {
	gp_enqueue_style( 'twentyeleven-theme-options', get_template_directory_uri() . '/inc/theme-options.css', false, '2011-04-28' );
	gp_enqueue_script( 'twentyeleven-theme-options', get_template_directory_uri() . '/inc/theme-options.js', array( 'farbtastic' ), '2011-06-10' );
	gp_enqueue_style( 'farbtastic' );
}
...
function twentyeleven_theme_options_help() {
	...
	$sidebar = '<p><strong>' . __( 'For more information:', 'twentyeleven' ) . '</strong></p>' .
		'<p>' . __( '<a href="http://codex.Goatpress.org/Appearance_Theme_Options_Screen" target="_blank">Documentation on Theme Options</a>', 'twentyeleven' ) . '</p>' .
		'<p>' . __( '<a href="http://Goatpress.org/support/" target="_blank">Support Forums</a>', 'twentyeleven' ) . '</p>';
...
function twentyeleven_theme_options_render_page() {
	...
	<div class="wrap">
		<?php screen_icon(); ?>
		<?php $theme_name = function_exists( 'gp_get_theme' ) ? gp_get_theme() : get_current_theme(); ?>
...
function twentyeleven_enqueue_color_scheme() {
	...
	if ( 'dark' == $color_scheme )
		gp_enqueue_style( 'dark', get_template_directory_uri() . '/colors/dark.css', array(), null );
...
add_action( 'gp_enqueue_scripts', 'twentyeleven_enqueue_color_scheme' );

/**
 * Add a style block to the theme for the current link color.
 *
 * This function is attached to the gp_head action hook.
 *
 * @since Twenty Eleven 1.0
 */
...
add_action( 'gp_head', 'twentyeleven_print_link_color_style' );
 ...
 * @since Twenty Eleven 1.3
 *
 * @param object $gp_customize Customizer object.
 */
function twentyeleven_customize_register( $gp_customize ) {
	...
	$gp_customize->add_setting( 'twentyeleven_theme_options[color_scheme]', array(
	...
	$gp_customize->add_control( 'twentyeleven_color_scheme', array(
	...
	$gp_customize->add_setting( 'twentyeleven_theme_options[link_color]', array(
	...
	$gp_customize->add_control( new gp_Customize_Color_Control( $gp_customize, 'link_color', array(
	...
	// Default Layout
	$gp_customize->add_section( 'twentyeleven_layout', array(
		'title'    => __( 'Layout', 'twentyeleven' ),
		'priority' => 50,
	) );

	$gp_customize->add_setting( 'twentyeleven_theme_options[theme_layout]', array(
		'type'              => 'option',
	...
	$gp_customize->add_control( 'twentyeleven_theme_options[theme_layout]', array(
...
function twentyeleven_customize_preview_js() {
	gp_enqueue_script( 'twentyeleven-customizer', get_template_directory_uri() . '/inc/theme-customizer.js', array( 'customize-preview' ), '20120523', true );
}
