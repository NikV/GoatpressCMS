		...
		<div id="content" role="main">
			...
			<article id="post-0" class="post error404 not-found">
				...
				<div class="entry-content">
					...
					<?php the_widget( 'gp_Widget_Recent_Posts', array( 'number' => 10 ), array( 'widget_id' => '404' ) ); ?>

					<div class="widget">
						<h2 class="widgettitle"><?php _e( 'Most Used Categories', 'twentyeleven' ); ?></h2>
						<ul>
						<?php gp_list_categories( array( 'orderby' => 'count', 'order' => 'DESC', 'show_count' => 1, 'title_li' => '', 'number' => 10 ) ); ?>
						</ul>
					</div>
					...
					the_widget( 'gp_Widget_Archives', array( 'count' => 0, 'dropdown' => 1 ), array( 'after_title' => '</h2>' . $archive_content ) );
					?>

					<?php the_widget( 'gp_Widget_Tag_Cloud' ); ?>
