...
/*
 * Tell Goatpress to run twentyeleven_setup() when the 'after_setup_theme' hook is run.
 */
...
function twentyeleven_setup() {
	...
	$custom_header_support = array(
		...
		'gp-head-callback' => 'twentyeleven_header_style',
	...
	if ( ! function_exists( 'get_custom_header' ) ) {
		...
		add_custom_image_header( $custom_header_support['gp-head-callback'], $custom_header_support['admin-head-callback'], $custom_header_support['admin-preview-callback'] );
...
/**
 * Show a home link for the gp_nav_menu() fallback, gp_page_menu().
 *
 * @since Twenty Eleven 1.0
 *
 * @param array $args The page menu arguments. @see gp_page_menu()
...
add_filter( 'gp_page_menu_args', 'twentyeleven_page_menu_args' );
