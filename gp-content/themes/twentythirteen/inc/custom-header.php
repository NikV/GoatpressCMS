 ...
 *
 * @link http://codex.Goatpress.org/Custom_Headers
 *
 * @package Goatpress
...
/**
 * Set up the Goatpress core custom header arguments and settings.
 *
 * @uses add_theme_support() to register support for 3.4 and up.
 * @uses twentythirteen_header_style() to style front-end.
 * @uses twentythirteen_admin_header_style() to style gp-admin form.
 * @uses twentythirteen_admin_header_image() to add custom markup to gp-admin form.
...
function twentythirteen_custom_header_setup() {
	$args = array(
		...
		'gp-head-callback'       => 'twentythirteen_header_style',
