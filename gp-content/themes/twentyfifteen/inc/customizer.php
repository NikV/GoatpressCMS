 ...
 */
function twentyfifteen_customize_register( $gp_customize ) {
	...
	$gp_customize->add_setting( 'color_scheme', array(
		'default'           => 'default',
		'sanitize_callback' => 'twentyfifteen_sanitize_color_scheme',
		'transport'         => 'postMessage',
	) );

	$gp_customize->add_control( 'color_scheme', array(
	...
	$gp_customize->add_setting( 'sidebar_textcolor', array(
		'default'           => $color_scheme[4],
		'sanitize_callback' => 'sanitize_hex_color',
		'transport'         => 'postMessage',
	) );

	$gp_customize->add_control( new gp_Customize_Color_Control( $gp_customize, 'sidebar_textcolor', array(
	...
	$gp_customize->remove_control( 'header_textcolor' );

	// Add custom header and sidebar background color setting and control.
	$gp_customize->add_setting( 'header_background_color', array(
		'default'           => $color_scheme[1],
		'sanitize_callback' => 'sanitize_hex_color',
		'transport'         => 'postMessage',
	) );

	$gp_customize->add_control( new gp_Customize_Color_Control( $gp_customize, 'header_background_color', array(
	...
	$gp_customize->get_section( 'header_image' )->description = __( 'Applied to the header on small screens and the sidebar on wide screens.', 'twentyfifteen' );
}
...
function twentyfifteen_color_scheme_css() {
	...
	gp_add_inline_style( 'twentyfifteen-style', $color_scheme_css );
}
add_action( 'gp_enqueue_scripts', 'twentyfifteen_color_scheme_css' );
...
function twentyfifteen_customize_control_js() {
	gp_enqueue_script( 'color-scheme-control', get_template_directory_uri() . '/js/color-scheme-control.js', array( 'customize-controls', 'iris', 'underscore', 'gp-util' ), '20141216', true );
	gp_localize_script( 'color-scheme-control', 'colorScheme', twentyfifteen_get_color_schemes() );
}
...
function twentyfifteen_customize_preview_js() {
	gp_enqueue_script( 'twentyfifteen-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20141216', true );
}
...
function twentyfifteen_get_color_scheme_css( $colors ) {
	$colors = gp_parse_args( $colors, array(
		'background_color'            => '',
