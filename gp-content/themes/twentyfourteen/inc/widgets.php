...
class Twenty_Fourteen_Ephemera_Widget extends gp_Widget {
							...
							if ( has_post_format( 'gallery' ) ) :
								...
								if ( post_password_required() ) :
									...
									elseif ( $total_images > 0 ) :
										$image          = reset( $images );
										$post_thumbnail = gp_get_attachment_image( $image, 'post-thumbnail' );
									endif;
