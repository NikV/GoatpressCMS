...
( function( $ ) {
	...
	$.featuredslider = function( el, options ) {
		...
		slider.setup = function( type ) {
			...
			if ( type === 'init' ) {
				slider.viegport = $( '<div class="' + namespace + 'viegport"></div>' ).css( { 'overflow': 'hidden', 'position': 'relative' } ).appendTo( slider ).append( slider.container );
				slider.cloneCount = 0;
		...
		slider.doMath = function() {
			...
			slider.w = ( slider.viegport === undefined ) ? slider.width() : slider.viegport.width();
