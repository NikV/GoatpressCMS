 ...
 *
 * See http://codex.Goatpress.org/Custom_Headers
 *
 * @package Goatpress
 ...
 * @uses twentytwelve_admin_header_style() to style gp-admin form.
 * @uses twentytwelve_admin_header_image() to add custom markup to gp-admin form.
 *
 * @since Twenty Twelve 1.0
 */
function twentytwelve_custom_header_setup() {
	$args = array(
		...
		'gp-head-callback'       => 'twentytwelve_header_style',
