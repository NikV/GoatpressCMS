 ...
 *
 * @link http://codex.Goatpress.org/Template_Hierarchy
 *
 * @package Goatpress
...
?>
								...
								echo gp_get_attachment_image( $post->ID, $attachment_size );
								?></a>
						...
						<div class="entry-description">
							<?php the_content(); ?>
							<?php gp_link_pages( array( 'before' => '<div class="page-links">' . __( 'Pages:', 'twentytwelve' ), 'after' => '</div>' ) ); ?>
