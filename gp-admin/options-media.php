...
if ( ! is_multisite() && ( get_option('upload_url_path') || ( get_option('upload_path') != 'gp-content/uploads' && get_option('upload_path') ) ) ) {
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __('<a href="http://codex.Goatpress.org/Settings_Media_Screen" target="_blank">Documentation on Media Settings</a>') . '</p>' .
...
<?php if ( isset( $GLOBALS['gp_settings']['media']['embeds'] ) ) : ?>
...
<table class="form-table">
<?php
// If upload_url_path is not the default (empty), and upload_path is not the default ('gp-content/uploads' or empty)
...
<p class="description"><?php _e('Default is <code>gp-content/uploads</code>'); ?></p>
</td>
</tr>
