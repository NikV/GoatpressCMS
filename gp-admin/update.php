...
if ( isset($_GET['action']) ) {
	...
	if ( 'update-selected' == $action ) {
		if ( ! current_user_can( 'update_plugins' ) )
			gp_die( __( 'You do not have sufficient permissions to update plugins for this site.' ) );
		...
		if ( ! isset($_GET['failure']) && ! isset($_GET['success']) ) {
			gp_redirect( admin_url('update.php?action=activate-plugin&failure=true&plugin=' . urlencode( $plugin ) . '&_gpnonce=' . $_GET['_gpnonce']) );
			activate_plugin( $plugin, '', ! empty( $_GET['networkwide'] ), true );
			gp_redirect( admin_url('update.php?action=activate-plugin&success=true&plugin=' . urlencode( $plugin ) . '&_gpnonce=' . $_GET['_gpnonce']) );
			die();
		}
		...
		include_once( ABSPATH . 'gp-admin/includes/plugin-install.php' ); //for plugins_api..
		...
		if ( ! current_user_can('update_themes') )
			gp_die(__('You do not have sufficient permissions to update themes for this site.'));
		...
		include_once( ABSPATH . 'gp-admin/includes/theme-install.php' ); //for themes_api..
		 ...
		 * provided in the request for gp-admin/update.php. Can be used to
