...
$menu[4] = array( '', 'read', 'separator1', '', 'gp-menu-separator' );
...
$_gp_last_object_menu = 25; // The index of the last top-level menu in the object menu group
...
foreach ( (array) get_post_types( array('show_ui' => true, '_builtin' => false, 'show_in_menu' => true ) ) as $ptype ) {
	...
	if ( $ptype_obj->show_in_menu !== true )
		continue;
	$ptype_menu_position = is_int( $ptype_obj->menu_position ) ? $ptype_obj->menu_position : ++$_gp_last_object_menu; // If we're to use $_gp_last_object_menu, increment it first.
...
$menu[59] = array( '', 'read', 'separator2', '', 'gp-menu-separator' );
...
$menu[60] = array( __( 'Appearance' ), $appearance_cap, 'themes.php', '', 'menu-top menu-icon-appearance', 'menu-appearance', 'dashicons-admin-appearance' );
	...
	$customize_url = add_query_arg( 'return', urlencode( gp_unslash( $_SERVER['REQUEST_URI'] ) ), 'customize.php' );
...
if ( current_user_can('list_users') ) {
	$_gp_real_parent_file['profile.php'] = 'users.php'; // Back-compat for plugins adding submenus to profile.php.
...
$menu[75] = array( __('Tools'), 'edit_posts', 'tools.php', '', 'menu-top menu-icon-tools', 'menu-tools', 'dashicons-admin-tools' );
	...
	if ( ! is_multisite() && defined('gp_ALLOW_MULTISITE') && gp_ALLOW_MULTISITE )
...
$_gp_last_utility_menu = 80; // The index of the last top-level menu in the utility menu group

$menu[99] = array( '', 'read', 'separator-last', '', 'gp-menu-separator' );

// Back-compat for old top-levels
$_gp_real_parent_file['post.php'] = 'edit.php';
$_gp_real_parent_file['post-new.php'] = 'edit.php';
$_gp_real_parent_file['edit-pages.php'] = 'edit.php?post_type=page';
$_gp_real_parent_file['page-new.php'] = 'edit.php?post_type=page';
$_gp_real_parent_file['gpmu-admin.php'] = 'tools.php';
$_gp_real_parent_file['ms-admin.php'] = 'tools.php';
