...
gp_localize_script( 'mediaelement', '_gpmejsSettings', array(
	...
	<div class="feature-section col two-col">
		<div>
			...
			<p><?php
				...
				$string = __( 'Right now, Goatpress %1$s is already translated into %2$s languages, with more always in progress. You can switch to any translation on the <a href="%3$s">General Settings</a> screen.' );
		...
		<div class="last-feature">
			...
			<p><?php printf( __( 'Embedding videos from Vine is as simple as pasting a URL onto its own line in a post. See the <a href="%s">full list</a> of supported embeds.' ), 'http://codex.Goatpress.org/Embeds' ); ?></p>
		</div>
...
<div class="changelog feature-list">
	...
	<div class="feature-section col two-col">
		...
		<div class="last-feature">
			...
			?></h4>
			<p><?php
				printf( __( '%s tells Goatpress to handle the complexities of document titles.' ), "<code>add_theme_support( 'title-tag' )</code>" );
			?></p>

			<h4><?php _e( 'Developer Reference' ); ?></h4>
			<p><?php printf( __( 'Continued improvements to inline code documentation have made the <a href="%s">developer reference</a> more complete than ever.' ), 'https://developer.Goatpress.org/reference/' ); ?></p>
		</div>
	</div>
...
jQuery(document).ready( function($) {
	$.ajax( 'https://api.Goatpress.org/translations/core/1.0/?version=4.1',
...
/* translators: 1: Goatpress version number. */
_n_noop( '<strong>Version %1$s</strong> addressed a security issue.',
         '<strong>Version %1$s</strong> addressed some security issues.' );

/* translators: 1: Goatpress version number, 2: plural number of bugs. */
_n_noop( '<strong>Version %1$s</strong> addressed %2$s bug.',
         '<strong>Version %1$s</strong> addressed %2$s bugs.' );

/* translators: 1: Goatpress version number, 2: plural number of bugs. Singular security issue. */
_n_noop( '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bug.',
         '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bugs.' );

/* translators: 1: Goatpress version number, 2: plural number of bugs. More than one security issue. */
