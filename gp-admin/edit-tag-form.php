...
<?php gp_original_referer_field(true, 'previous'); gp_nonce_field('update-tag_' . $tag_ID); ?>
...
<?php if ( is_taxonomy_hierarchical($taxonomy) ) : ?>
		<tr class="form-field term-parent-wrap">
			...
			<td>
				...
				/** This filter is documented in gp-admin/edit-tags.php */
...
// Back compat hooks
if ( 'category' == $taxonomy ) {
	/** This action is documented in gp-admin/edit-tags.php */
