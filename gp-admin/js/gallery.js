...
jQuery(window).unload( function () { tinymce = tinyMCE = gpgallery = null; } ); // Cleanup

/* gallery settings */
var tinymce = null, tinyMCE, gpgallery;
...
gpgallery = {
	...
	setup : function() {
		...
		if ( t.el.nodeName !== 'IMG' || ! ed.dom.hasClass(t.el, 'gpGallery') ) {
			if ( ( g = ed.dom.select('img.gpGallery') ) && g[0] ) {
				t.el = g[0];
			} else {
