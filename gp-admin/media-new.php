...
gp_enqueue_script('plupload-handlers');
...
if ( $_POST ) {
	...
	gp_redirect( admin_url( $location ) );
	exit;
}
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __('<a href="http://codex.Goatpress.org/Media_Add_New_Screen" target="_blank">Documentation on Uploading Media Files</a>') . '</p>' .
